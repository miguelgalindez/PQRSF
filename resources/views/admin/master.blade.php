...
<script type="text/javascript" src="{!! asset('plugins/datetimepicker/moment.js') !!}"></script>
<script src="{!! asset('plugins/datatables/datatables.js') !!}"></script>
<script type="text/javascript" src="{!! asset('plugins/datetimepicker/bootstrap-datetimepicker.js') !!}"></script>
<script type="text/javascript" src="{!! asset('plugins/datetimepicker/es.js') !!}"></script>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>PQRS</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="{{ asset('img/pqrsf-icon.svg') }}"></span>
    </a>
